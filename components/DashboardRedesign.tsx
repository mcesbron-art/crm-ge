...
function ProjetRow({
  ...
  const hoverBg = isDark ? "#2F2F2F" : "#F5F5F3";
  const textColor = isDark ? "#E8E8E8" : "#1A1A1A";
  const borderColor = isDark ? "#2F2F2F" : "#E0E0DE";
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        {[...new Set(projet.taches.map((t) => t.collab).filter(Boolean))]
          .slice(0, 3)
          .map((cid) => (
    ...
    >
      <div className="animate-fadeIn">
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns: canSeeMoney ? "repeat(4, 1fr)" : "repeat(4, 1fr)",
            gap: 20,
            marginBottom: 40,
          }}
        >
          ...
          />
          <KPICard
            label={canSeeMoney ? "Alertes rentabilité" : "Alertes temps"}
            value={alertes}
        ...
        >
          ...
          >
            ...
            <div style={{ paddingLeft: 8 }}>
              {canSeeMoney ? "Rentabilité" : "Avancement"}
            </div>
