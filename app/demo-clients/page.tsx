    ...
    <div style={{ background: "#F5F4EF", minHeight: "100vh", padding: "26px 30px", fontFamily: "var(--font-plus-jakarta), sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 10, flexShrink: 0 }}>
          <button style={{ padding: "6px 12px", background: "#F5F4EF", border: "none", borderRadius: 5, fontSize: 10, fontWeight: 600, cursor: "pointer", fontFamily: "var(--font-plus-jakarta), sans-serif", color: "#1C1B16", whiteSpace: "nowrap" }}>
            ☎️ Contacter
          </button>
